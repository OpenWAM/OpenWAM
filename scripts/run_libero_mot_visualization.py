...
def main() -> None:
    ...
    runtime = load_mot_libero_runtime(
        MotLiberoLoadOptions(
            config=args.config,
            ...
            checkpoint_error=(
                "MoT visualization requires a trained checkpoint. Pass "
    ...
    task_resources = resolve_mot_libero_task_resources(
        args.benchmark,
        args.task_id,
    )
    env = construct_mot_libero_env(task_resources.task_spec)
    episode = MotLiberoEpisodeOptions(

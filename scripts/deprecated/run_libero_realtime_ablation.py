...
from open_wam.utils.libero_paradigm import require_current_libero_script
...
DEFAULT_CASES: dict[str, RolloutCase] = {
    ...
    "method5_mot_idm_step1900": RolloutCase(
        ...
        config=Path("configs/experiments/deprecated/mot_libero_latent_local_idm.yaml"),
    ...
    "method5_mot_joint_step900": RolloutCase(
        ...
        config=Path("configs/experiments/deprecated/mot_libero_latent_local_joint.yaml"),
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "LIBERO M1/M5 cases fail before rollout."
        ),
    )
    ...
    require_current_libero_script(
        "scripts/deprecated/run_libero_realtime_ablation.py",

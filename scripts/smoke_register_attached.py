...
from open_wam.configs import ActionSchemaConfig, RegisterAttachedPolicyConfig, RobotWinDataConfig  # noqa: E402
...
from open_wam.models.action_decoders import RegisterActionDecoder  # noqa: E402
from open_wam.models.policy_variants import PolicyInferContext, PolicyTrainBatch, RegisterAttachedPolicyVariant  # noqa: E402
...
def main() -> None:
    ...
    data_config = RobotWinDataConfig(
        num_frames=4,
        action_schema=ActionSchemaConfig(action_dim=30, action_horizon=6, state_dim=30, state_horizon=3),
    )
    ...
    pipeline = VariantPipeline(
        ...
        policy_variant=RegisterAttachedPolicyVariant(
            ...
            inference_config=InferenceConfig(frame_chunk_size=1),
        ...
        action_decoder=RegisterActionDecoder(hidden_size=256, action_dim=30, action_horizon=6),

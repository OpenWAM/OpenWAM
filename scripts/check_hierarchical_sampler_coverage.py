...
def build_coverage_report(
    *,
    ...
    return {
        ...
        "missing_start_examples": [{"trajectory_window_index": key[0], "latent_start": key[1]} for key in missing_keys[:20]],
        "extra_start_count": len(extra_keys),
        "extra_start_examples": [{"trajectory_window_index": key[0], "latent_start": key[1]} for key in extra_keys[:20]],

...
def main() -> None:
    ...
    parser.add_argument(
        ...
        choices=(
            dual_expert_runtime.DEPRECATED_FRONTEND_ENCODE_MODE,
            dual_expert_runtime.CURRENT_FRONTEND_ENCODE_MODE,
        ),
        default=dual_expert_runtime.CURRENT_FRONTEND_ENCODE_MODE,
        help=(
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/libero_dual_expert_visualization_batch")
    ...
    try:
        for suffix, explicit_seed in rollout_seed_specs:
            ...
            for task_id, episode_idx in pairs:
                ...
                dual_expert_runtime.print_rollout_event(
                    "batch_rollout_start",
...
def _run_one_loaded_rollout(
    ...
    *,
    ...
    episode = dual_expert_viz.DualExpertLiberoEpisodeOptions(

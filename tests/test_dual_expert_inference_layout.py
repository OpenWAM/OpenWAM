...
def test_conditional_rollout_inputs_strip_startup_action_prefix_and_prepend_video_anchor() -> None:
    ...
    inputs = layout.resolve_conditional_rollout_inputs(
        {
            "dual_expert_forced_action_latents": forced_action_sequence,
            "dual_expert_commit_action_latents": commit_actions,
            "dual_expert_video_condition_latents": video_condition,
        },
        generalist_rollout_mode=GeneralistDenoisingMode.ACTION_CONDITIONED_VIDEO,

...
def build_parallel_first_frame_attention_profile(
    *,
    batch_size: int,
    video_seq_len: int,
    action_seq_len: int,
...
def run_parallel_first_frame_conditioned_forward(
    transformer: torch.nn.Module,
    input_dict: dict[str, torch.Tensor | dict[str, torch.Tensor]],
) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    attention_profile = build_parallel_first_frame_attention_profile(
...
def run_parallel_first_frame_conditioned_train(
    transformer: torch.nn.Module,
    input_dict: dict[str, torch.Tensor | dict[str, torch.Tensor]],
) -> tuple[torch.Tensor, torch.Tensor]:
    return run_parallel_first_frame_conditioned_forward(transformer, input_dict)

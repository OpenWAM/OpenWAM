...
_LAZY_EXPORTS = {
    "DatasetArtifactKind": "artifacts",
    "DatasetArtifactPreflightError": "artifacts",
    "DatasetArtifactRequirement": "artifacts",
    "DatasetArtifactStatus": "artifacts",
    "check_dataset_artifacts": "artifacts",
    "require_dataset_artifacts": "artifacts",
    ...
    "ENCODED_DYNAMICS_ARTIFACT_SCHEMA_V1": "encoded_dynamics_dataset",
    "EncodedDynamicsArtifact": "encoded_dynamics_dataset",
    "EncodedDynamicsLatentDataset": "encoded_dynamics_dataset",
    "EncodedDynamicsResources": "encoded_dynamics_dataset",
    "load_encoded_dynamics_artifact": "encoded_dynamics_dataset",
    "migrate_encoded_dynamics_artifact": "encoded_dynamics_dataset",
    "preflight_encoded_dynamics_artifact": "encoded_dynamics_dataset",
    "DynamicsDatasetPlan": "dynamics_routing",
    "DynamicsRouteKey": "dynamics_routing",
    "DynamicsRoutingDataset": "dynamics_routing",
    "DynamicsSourceViewProvider": "dynamics_routing",
    "build_train_val_datasets": "factory",
    "build_dynamics_routing_datasets": "dynamics_routing",
    "resolve_dynamics_dataset_plan": "dynamics_routing",
    "resolve_dataset_loader_spec": "factory",
    "DynamicsRoutingSampleMetadata": "sample_metadata",
    ...
    "DatasetArtifactResolver": "registries",
    ...
    "preflight_dataset_artifacts": "registries",
    ...
    "MixedVideoCatalog": "mixed_video_catalog_contracts",
    ...
    "load_mixed_video_catalog": "mixed_video_catalog_assembly",
    "split_mixed_video_episodes": "mixed_video_catalog_split",

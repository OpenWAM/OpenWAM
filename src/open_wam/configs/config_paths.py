...
EXPERIMENT_CONFIG_ALIASES = MappingProxyType(
    {
        "mot_libero_latent_local_action_noisy_to_video_heng_compatible": (
            "mot_libero_action_noisy_to_video"
        ),
        "mot_libero_latent_local_action_then_video_heng_compatible": "mot_libero_action_then_video",
        "mot_libero_latent_local_decoupled_same_step_heng_compatible": "mot_libero_decoupled_same_step",
        "mot_libero_latent_local_generalist_joint_denoising_heng_compatible": (
            "mot_libero_generalist_joint_denoising"
        ),
        "mot_libero_latent_local_joint_heng_compatible": "mot_libero_joint",
        "mot_libero_latent_local_video_noisy_to_action_heng_compatible": (
            "mot_libero_video_noisy_to_action"
        ),
...
_CONFIG_ALIASES = MappingProxyType(
    {**EXPERIMENT_CONFIG_ALIASES, **EVALUATION_CONFIG_ALIASES}
)
...
def resolve_config_path_alias(path: str | Path, *, warn: bool = True) -> Path:
    ...
    canonical_stem = _CONFIG_ALIASES.get(old_stem)
    ...
    canonical_root = (
        ...
        if old_stem in EXPERIMENT_CONFIG_ALIASES
        else EVALUATION_CONFIG_ROOT
    )

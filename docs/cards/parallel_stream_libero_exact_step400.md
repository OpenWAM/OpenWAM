# Parallel-Stream LIBERO Exact Step 400/1100 Layout Card

## Identity

- architecture: `parallel_stream`
- backend profile: `lingbot_exact`
- benchmark: `libero_10`
...
- artifact id: `parallel-stream-libero-exact-step400`
...
uv run --extra sim python scripts/run_libero_realtime_sandbox.py \
  ...
  --output-dir outputs/libero_parallel_stream_recommended \
